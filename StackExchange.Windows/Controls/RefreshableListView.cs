...
namespace StackExchange.Windows.Controls
{
    /// <summary>
    /// Extension of the ListView control that allows "Pull To Refresh" operations on touch devices.
    /// Taken from https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/XamlPullToRefresh.
    /// </summary>
    ...
    public class RefreshableListView : ListView
    {
        ...
        private void Scroller_DirectManipulationStarted(object sender, object e)
        {
            ...
            {
                global::Windows.UI.Xaml.Media.CompositionTarget.Rendering += CompositionTarget_Rendering;
